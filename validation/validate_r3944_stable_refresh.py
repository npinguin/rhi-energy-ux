...
checks = {    'metering_records_owner': "function selectEnergyMetering" in source and "canonical_period_energy_not_published" in source,
    ...
    'canonical_home_consumption_breakdown': "balanceVm.homeConsumptionKw" in source and "readLiveConsumptionContract" in source,
    ...
    'two_level_navigation_sections': "const HB_ENERGY_NAVIGATION = Object.freeze([" in source and 'id: "energy"' in source and 'id: "intelligence"' in source and 'id: "insights"' in source,
    'energy_navigation_order': 'id:"overview", label:"Overview"' in source and 'id:"flow", label:"Flow"' in source and 'id:"solar", label:"Solar", view:"solar"' in source,
    'operational_planning_owns_renderer': 'id:"operational-planning", label:"Operational Planning", view:"operational-planning"' in source and "this.view === 'operational-planning' ? this.operationalPlanning(rt)" in source,
