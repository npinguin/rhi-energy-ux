...
checks = {
    'release_identity': manifest.get('release') == 'R3.94.7' and evidence.get('release') == 'R3.94.7' and "const UX_VERSION = 'R3.94.7'" in source,
    ...
    'canonical_style_marker_once': source.count('R3.94.7 canonical core-tab stylesheet') == 1,
