...
checks={
 ...
 'connection_detail_fails_closed': 'Canonical physical connection telemetry is not published by E0.15.48.' in flow_block and 'rows:Object.freeze([])' in flow_block,
