...
.navProductArea{min-width:0}.navPrimaryRow{min-height:78px;display:grid;grid-template-columns:minmax(240px,.60fr) minmax(0,1.40fr);align-items:center;gap:18px;padding:10px 22px 9px}.navBrand{display:flex;align-items:center;min-width:0;min-height:56px;padding:2px 0 0 4px}.navBrandCopy{display:grid;align-content:center;gap:2px;min-width:0}.navBrandCopy b{font-size:15px;line-height:1.1;font-weight:520;letter-spacing:-.01em;color:#58708f;white-space:nowrap}.navBrandCopy small{font-size:24px;line-height:1.02;letter-spacing:.055em;font-weight:790;color:#0b467f;white-space:nowrap}
...
@media(max-width:1180px){.navigationShell{--rhi-company-area-min:220px;--rhi-company-area-max:250px;--rhi-company-logo-max-width:220px;--rhi-company-logo-max-height:94px;--rhi-company-logo-padding:8px 12px}.navPrimaryRow{grid-template-columns:minmax(205px,.56fr) minmax(0,1.44fr);gap:12px;padding-inline:16px}.navSections{gap:6px}.navSectionTab{padding:9px 8px;font-size:11.5px}.navBrandCopy b{font-size:13.5px}.navBrandCopy small{font-size:21px}.navItems.tabs{gap:7px!important;padding-inline:16px!important}.navItemTab{padding:7px 13px;font-size:11px}.navCompany{padding-inline:12px}}
