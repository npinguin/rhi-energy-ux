...
function hbEnergyPresentationStyles() {
  return `${rhiUxCoreStyles()}
    ...
    .energyAssetQuickActions{display:flex;gap:6px;flex-wrap:wrap;margin-top:7px}
    .energyAssetQuickActions .hiAction{min-height:32px;padding:6px 9px;font-size:10px}
    .batteryContributorFacts{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:5px}
    .batteryContributorFacts span{min-width:0;padding:6px 7px;border-radius:8px;background:var(--rhi-color-surface-soft)}
    .batteryContributorFacts small,.batteryContributorFacts b{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
    .batteryContributorFacts small{font-size:8.5px;color:var(--rhi-color-muted)}
    .batteryContributorFacts b{font-size:10.5px;margin-top:2px}
    ...
    @media(max-width:430px){
      ...
      .batteryContributorFacts{grid-template-columns:1fr 1fr}
    }
  `;
}
