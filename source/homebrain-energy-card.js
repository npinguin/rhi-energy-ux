...
// END GENERATED MODULE: planning/planning-view-model.js
  ...
  class HomeBrainEnergyCard extends HTMLElement {
    ...
    nav() {
      ...
      return `<div class="navigationShell nav-${escapeHtml(active.section)}"><nav class="navSections" aria-label="Energy sections">${sectionNav}</nav><nav class="tabs navItems" aria-label="${escapeHtml(currentSection.label)}">${itemNav}</nav></div>`;
    }
    onClick(event) {
...
.productBrand{display:flex;align-items:center;gap:9px;margin:0 4px 7px;color:#94a3b8}.productBrand span{font-size:8.5px;letter-spacing:.15em;font-weight:700}.productBrand b{font-size:9.5px;font-weight:700;color:#64748b}.productBrand b:before{content:"/";margin-right:9px;color:#d5dde8}
.navigationShell{--nav-active-bg:#edf5ff;--nav-active-border:#cfdef1;--nav-active-text:#173f70;display:grid;gap:0;margin:0 0 10px;background:rgba(255,255,255,.68);border:1px solid rgba(203,213,225,.72);border-radius:18px;box-shadow:0 7px 22px rgba(15,23,42,.035);overflow:hidden;backdrop-filter:blur(14px)}.navigationShell.nav-intelligence{--nav-active-bg:#f1edff;--nav-active-border:#ded5fb;--nav-active-text:#5531a5}.navigationShell.nav-insights{--nav-active-bg:#e8f8f5;--nav-active-border:#cdece6;--nav-active-text:#176b65}
...
.navSections{gap:3px;padding:7px 10px 6px;background:transparent;border:0;border-radius:0;max-width:100%}.navSectionTab{min-height:34px;border:0;border-radius:10px;background:transparent;padding:6px 15px;font:inherit;font-size:10.5px;font-weight:660;color:#708097;cursor:pointer;white-space:nowrap;transition:background .15s ease,color .15s ease,box-shadow .15s ease}.navSectionTab:hover{background:rgba(248,250,252,.8);color:#334155}.navSectionTab.active{background:rgba(255,255,255,.92);color:#172033;box-shadow:0 3px 10px rgba(15,23,42,.045),inset 0 0 0 1px rgba(203,213,225,.62)}
.navItems.tabs{margin:0!important;padding:6px 10px 7px!important;gap:3px!important;border:0!important;border-top:1px solid rgba(226,232,240,.72)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;backdrop-filter:none!important}.navItemTab{flex:0 0 auto;min-height:36px;border:0;border-radius:10px;background:transparent;padding:7px 15px;font:inherit;font-size:11px;font-weight:610;color:#52627a;cursor:pointer;white-space:nowrap;transition:background .15s ease,color .15s ease,box-shadow .15s ease}.navItemTab:hover{background:rgba(248,250,252,.78);color:#253247}.navItemTab.active{background:var(--nav-active-bg);color:var(--nav-active-text);box-shadow:inset 0 0 0 1px var(--nav-active-border)}
...
@media(max-width:700px){.productBrand{margin-bottom:5px}.navigationShell{margin-bottom:8px;border-radius:15px}.navSections{width:100%;box-sizing:border-box;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));padding:5px 6px 4px}.navSectionTab{min-width:0;min-height:34px;padding:5px 3px;font-size:10px}.navItems.tabs{display:flex!important;grid-template-columns:none!important;overflow-x:auto!important;white-space:nowrap!important;padding:5px 6px 6px!important}.navItemTab{min-height:35px;padding:6px 11px;font-size:10.5px}.hiTabHeroCopy h2{font-size:18px!important}.hiTabPurpose{font-size:10px!important;margin-bottom:8px!important;display:block!important;-webkit-line-clamp:unset!important}.hiTabLiveLine strong{font-size:9.5px}.hiTabLiveLine .hiTabHeroValue{font-size:24px!important}}
@media(max-width:390px){.navItemTab{padding:6px 9px;font-size:10px}.hiTabPurpose{max-width:48ch}}
</style><main class="energy"><div class="productBrand"><span>HOME INTELLIGENCE</span><b>${escapeHtml(this.navigationModel().find(section => section.id === this.navSection)?.label || 'Energy')}</b></div>${this.nav()}${this.renderMainWarning(footer)}<section>${this.productLanguage(content)}</section>${this.propertyDraftBar()}${this.productLanguage(this.renderFooter(rt,this.view,footer))}</main>`;
