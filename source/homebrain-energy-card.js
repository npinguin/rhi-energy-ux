...
// END GENERATED MODULE: planning/planning-view-model.js
  ...
  class HomeBrainEnergyCard extends HTMLElement {
    ...
    nav() {
      const sections = this.navigationModel();
      const active = this.activeNavigation();
      const sectionIcon = { energy:'⚡', intelligence:'◉', insights:'▥' };
      const sectionNav = sections.map(section => `<button class="navSectionTab ${active.section === section.id ? 'active' : ''}" data-nav-section="${escapeHtml(section.id)}"><span class="navSectionIcon" aria-hidden="true">${escapeHtml(sectionIcon[section.id] || '•')}</span><span>${escapeHtml(section.label)}</span></button>`).join('');
      ...
      return `<div class="navigationShell nav-${escapeHtml(active.section)}">
        <div class="navPrimaryRow">
          <div class="navBrand" aria-label="Home Intelligence Energy">
            <span class="navBrandMark" aria-hidden="true">⌂</span>
            <span class="navBrandCopy"><b>Home Intelligence</b><small>ENERGY</small></span>
          </div>
    ...
    navigationPlaceholder(rt, view) {
      ...
      const model = { ...p, image:'/local/homebrain/infrastructure/energy/intelligence-hero.webp', icon:'◇', title:'Strategic planning', value:'—', unit:'longer-term horizon', explanation:'Longer-term goals, constraints and optimisation', badgeText:'Structure ready', badgeTone:'neutral', metrics:[['◎','Horizon','—','Longer-term'],['◇','Goals','—','Not migrated yet'],['◫','Constraints','—','Not migrated yet'],['↗','Optimisation','—','Not migrated yet']] };
...
.navigationShell{--nav-active-bg:#edf5ff;--nav-active-border:#cfdef1;--nav-active-text:#0f4ca4;display:grid;gap:0;margin:0 0 12px;background:linear-gradient(180deg,rgba(255,255,255,.95),rgba(249,251,254,.9));border:1px solid rgba(207,217,230,.86);border-radius:22px;box-shadow:0 12px 30px rgba(15,23,42,.045);overflow:hidden;backdrop-filter:blur(16px)}.navigationShell.nav-intelligence{--nav-active-bg:#f1edff;--nav-active-border:#dfd5fb;--nav-active-text:#5a38b3}.navigationShell.nav-insights{--nav-active-bg:#e7f7f4;--nav-active-border:#cdebe6;--nav-active-text:#176e67}
.navPrimaryRow{min-height:76px;display:grid;grid-template-columns:minmax(250px,.75fr) minmax(420px,1.25fr);align-items:center;gap:24px;padding:10px 20px 9px}.navBrand{display:flex;align-items:center;gap:12px;min-width:0}.navBrandMark{width:40px;height:40px;border-radius:12px;display:grid;place-items:center;background:linear-gradient(180deg,#eef5ff,#e5effd);color:#1769d2;font-size:22px;font-weight:800;box-shadow:inset 0 0 0 1px #d6e5f7,0 4px 12px rgba(37,99,235,.06)}.navBrandCopy{display:grid;gap:2px;min-width:0}.navBrandCopy b{font-size:15px;line-height:1.15;letter-spacing:-.01em;color:#15233a;white-space:nowrap}.navBrandCopy small{font-size:8.5px;letter-spacing:.16em;font-weight:760;color:#8090a6}
...
.navSections{justify-content:flex-start;gap:12px;padding:0;background:transparent;border:0;border-radius:0;max-width:100%}.navSectionTab{min-height:46px;border:0;border-radius:14px;background:transparent;padding:9px 18px;font:inherit;font-size:12px;font-weight:680;color:#53647d;cursor:pointer;white-space:nowrap;display:flex;align-items:center;gap:9px;transition:background .15s ease,color .15s ease,box-shadow .15s ease}.navSectionTab:hover{background:#f8fafc;color:#2f3f56}.navSectionTab.active{background:var(--nav-active-bg);color:var(--nav-active-text);box-shadow:inset 0 0 0 1px var(--nav-active-border),0 6px 16px rgba(15,23,42,.035)}.navSectionIcon{font-size:15px;line-height:1}
.navItems.tabs{margin:0!important;padding:8px 18px 10px!important;gap:12px!important;border:0!important;border-top:1px solid rgba(226,232,240,.82)!important;border-radius:0!important;background:rgba(255,255,255,.52)!important;box-shadow:none!important;backdrop-filter:none!important;min-height:54px}.navItemTab{flex:0 0 auto;min-height:38px;border:0;border-radius:11px;background:transparent;padding:8px 16px;font:inherit;font-size:11.5px;font-weight:610;color:#516077;cursor:pointer;white-space:nowrap;transition:background .15s ease,color .15s ease,box-shadow .15s ease}.navItemTab:hover{background:#f8fafc;color:#2f3f56}.navItemTab.active{background:var(--nav-active-bg);color:var(--nav-active-text);box-shadow:inset 0 0 0 1px var(--nav-active-border)}
...
@media(max-width:980px){.navPrimaryRow{grid-template-columns:minmax(210px,.65fr) minmax(0,1.35fr);gap:14px;padding-inline:14px}.navSections{gap:6px}.navSectionTab{padding:8px 13px;font-size:11px}.navBrandMark{width:36px;height:36px}.navBrandCopy b{font-size:13.5px}.navItems.tabs{gap:6px!important;padding-inline:14px!important}.navItemTab{padding:7px 13px;font-size:11px}}
@media(max-width:700px){.navigationShell{margin-bottom:8px;border-radius:17px}.navPrimaryRow{display:grid;grid-template-columns:1fr;gap:6px;min-height:0;padding:10px 8px 6px}.navBrand{padding:0 4px}.navBrandMark{width:32px;height:32px;border-radius:10px;font-size:18px}.navBrandCopy b{font-size:12.5px}.navBrandCopy small{font-size:7.5px}.navSections{width:100%;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:5px}.navSectionTab{min-width:0;min-height:40px;justify-content:center;padding:7px 4px;font-size:10.5px;gap:6px}.navSectionIcon{font-size:13px}.navItems.tabs{display:flex!important;grid-template-columns:none!important;overflow-x:auto!important;white-space:nowrap!important;padding:5px 8px 7px!important;gap:4px!important;min-height:48px}.navItemTab{min-height:35px;padding:6px 11px;font-size:10.5px}.hiTabHeroCopy h2{font-size:18px!important}.hiTabPurpose{font-size:10px!important;margin-bottom:8px!important;display:block!important;-webkit-line-clamp:unset!important}.hiTabLiveLine strong{font-size:9.5px}.hiTabLiveLine .hiTabHeroValue{font-size:24px!important}}
@media(max-width:390px){.navBrandCopy small{display:none}.navSectionTab{font-size:10px}.navItemTab{padding:6px 9px;font-size:10px}.hiTabPurpose{max-width:48ch}}}
