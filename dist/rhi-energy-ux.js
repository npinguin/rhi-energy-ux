...
.navCompany{min-width:0;border-left:1px solid rgba(226,232,240,.82);display:grid;place-items:center;padding:12px 18px;background:linear-gradient(180deg,rgba(252,254,255,.78),rgba(247,250,253,.58))}.navCompanyLogo{display:block;width:min(100%,286px);height:auto;max-height:116px;object-fit:contain;}
