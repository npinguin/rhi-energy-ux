...
// Vendored build-time snapshot of npinguin/rhi-ux-core 1.4.1
// Source commit: 7e035980b690719ff9c05876e905322194d52df2
...
function rhiEnergyVisualPickerStyles() {
  ...
  class HomeBrainEnergyCard extends HTMLElement {
    ...
    outlook(rt) {
      ...
      return `${this.tabExperienceHeader(rt,'outlook',pageVm)}<div class="outlookPage r3468OutlookPage"><div class="outlookThreeGrid">
