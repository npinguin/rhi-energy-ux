    ...
    nav() {
      ...
      return `<div class="navigationShell nav-${escapeHtml(active.section)}">
        ...
        <div class="navCompany" aria-label="Robotix.be · DomotiX · Network · Security">
          <img class="navCompanyLogo" src="/hacsfiles/rhi-energy-ux/assets/company-logo.svg" alt="Robotix.be — DomotiX · Network · Security">
        </div>
      </div>`;
    }
    onClick(event) {
...
.navItems.tabs{margin:0!important;padding:8px 22px 10px!important;gap:14px!important;border:0!important;border-top:1px solid rgba(226,232,240,.82)!important;border-radius:0!important;background:rgba(255,255,255,.52)!important;box-shadow:none!important;backdrop-filter:none!important;min-height:56px}.navItemTab{flex:0 0 auto;min-height:38px;border:0;border-radius:12px;background:transparent;padding:8px 17px;font:inherit;font-size:12px;font-weight:610;color:#516077;cursor:pointer;white-space:nowrap;transition:background .15s ease,color .15s ease,box-shadow .15s ease}.navItemTab:hover{background:#f8fafc;color:#2f3f56}.navItemTab.active{background:var(--nav-active-bg);color:var(--nav-active-text);box-shadow:inset 0 0 0 1px var(--nav-active-border)}
.navCompany{min-width:0;border-left:1px solid rgba(226,232,240,.82);display:grid;place-items:center;padding:12px 18px;background:linear-gradient(180deg,rgba(252,254,255,.78),rgba(247,250,253,.58))}.navCompanyLogo{display:block;width:min(100%,286px);height:auto;max-height:116px;object-fit:contain;filter:saturate(.92)}
