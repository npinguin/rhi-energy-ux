...
.overviewHouseHeroImage{position:absolute;inset:0;background:linear-gradient(180deg,rgba(10,22,37,.08),rgba(10,22,37,.72)),url('/hacsfiles/rhi-energy-ux/assets/overview-hero.webp') center/cover no-repeat}
