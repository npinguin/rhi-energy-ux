...
3. Select **Dashboard**.
4. Install **v3.94.15** for this TEST CANDIDATE qualification.
...
5. Check the footer:
   - healthy: quiet gray `RHI Energy UX 3.94.15 · Backend E0.15.24`;
...
For the 3.94.15 rollout, select **v3.94.15** while qualifying the TEST CANDIDATE. The rollback target is **v3.94.14**.
